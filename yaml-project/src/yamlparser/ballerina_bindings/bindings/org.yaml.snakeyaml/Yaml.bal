...
class Yaml {
    ...
    *java:JObject;
    ...
    function addTypeDescription(TypeDescription arg0) {
        () obj = org_yaml_snakeyaml_Yaml_addTypeDescription(self.jObj, arg0.jObj);
    }
    ...
    function dump(Object arg0) returns string? {
        handle externalObj = org_yaml_snakeyaml_Yaml_dump(self.jObj, arg0.jObj);
    ...
    # + return - The `string?` value returning from the Java mapping.
    function dumpAll(Iterator arg0) returns string? {
        handle externalObj = org_yaml_snakeyaml_Yaml_dumpAll(self.jObj, arg0.jObj);
        return java:toString(externalObj);
    }
    ...
    function load(InputStream arg0) returns Object {
    ...
    # + arg0 - The `InputStream` value required to map with the Java method parameter.
    # + return - The `Iterable` value returning from the Java mapping.
    function loadAll(InputStream arg0) returns Iterable {
    ...
    # + return - The `Object` value returning from the Java mapping.
    function loadAs(InputStream arg0, Class arg1) returns Object {
    ...
    function 'wait() returns error? {
        error|() obj = org_yaml_snakeyaml_Yaml_wait(self.jObj);
        if (obj is error) {
...
# + return - The new `Yaml` object generated.
function newYaml6(BaseConstructor arg0, Representer arg1, DumperOptions arg2, LoaderOptions arg3, Resolver arg4) returns Yaml {
    handle obj = org_yaml_snakeyaml_Yaml_newYaml6(arg0.jObj, arg1.jObj, arg2.jObj, arg3.jObj, arg4.jObj);
    Yaml _yaml = new(obj);
    return _yaml;
}
...
function newYaml7(BaseConstructor arg0, Representer arg1, DumperOptions arg2, Resolver arg3) returns Yaml {
    handle obj = org_yaml_snakeyaml_Yaml_newYaml7(arg0.jObj, arg1.jObj, arg2.jObj, arg3.jObj);
    Yaml _yaml = new(obj);
    return _yaml;
}
...
function newYaml9(LoaderOptions arg0) returns Yaml {
    handle obj = org_yaml_snakeyaml_Yaml_newYaml9(arg0.jObj);
    Yaml _yaml = new(obj);
    return _yaml;
}
...
function newYaml10(Representer arg0) returns Yaml {
    handle obj = org_yaml_snakeyaml_Yaml_newYaml10(arg0.jObj);
    Yaml _yaml = new(obj);
    return _yaml;
}
...
function newYaml11(Representer arg0, DumperOptions arg1) returns Yaml {
    handle obj = org_yaml_snakeyaml_Yaml_newYaml11(arg0.jObj, arg1.jObj);
    Yaml _yaml = new(obj);
    return _yaml;
}
