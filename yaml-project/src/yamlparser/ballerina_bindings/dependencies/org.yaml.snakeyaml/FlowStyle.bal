...
# Ballerina object mapping for Java class `org.yaml.snakeyaml.DumperOptions$FlowStyle`.
#
# + _FlowStyle - The field that represents this Ballerina object, which is used for Java subtyping.
...
class FlowStyle {
    ...
    *java:JObject;
    ...
    FlowStyleT _FlowStyle = FlowStyleT;
    EnumT _Enum = EnumT;
    ComparableT _Comparable = ComparableT;
    SerializableT _Serializable = SerializableT;
    ObjectT _Object = ObjectT;

    # The init function of the Ballerina object mapping `org.yaml.snakeyaml.DumperOptions$FlowStyle` Java class.
    #
